...
| 中型紅色機器人 | 10 | 2 | 115 | 1.7 秒 | 250 | 第一至三關 |
| 彩色精英機器人 | 20 | 5 | 88 | 1.15 秒 | 600 | 第一至三關固定波次 |
...
第三關一般波次約有 25% 機率出現橫向鑽頭小兵。它會隨機選擇畫面左側或右側，以及隨機高度，沿水平方向平行穿越畫面；從右側出現時 Sprite 會自動鏡像，使鑽頭始終朝向移動方向。第三關整體生怪間隔約為 0.78～0.34 秒，比前兩關更密集。
