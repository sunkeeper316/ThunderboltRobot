...
玩家初始 HP 為 `100`，主炮射擊間隔為 `0.16 秒`。所有武器最高可升級 5 次。撿到已滿級的武器寶物時，會從其他尚未滿級的武器中隨機升級一種；若三種武器都已滿級，則只取得寶物分數。
...
|---|---:|---:|---:|---:|---:|
| 第一關：銀河前線 | 75 秒 | 第 78 秒 | 5 個 | 260 | 5 |
| 第二關：赤色風暴 | 110 秒 | 第 114 秒 | 10 個 | 420 | 10 |
| 第三關：蒼藍鑽皇 | 110 秒 | 第 114 秒 | 10 個 | 650 | 15 |
...
- 第三關：第 9、19、29、39、49、59、69、79、89、99 秒。
